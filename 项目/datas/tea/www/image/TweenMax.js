 ...
 * ----------------------------------------------------------------
 */
	_gsScope._gsDefine("TimelineMax", ["TimelineLite","TweenLite","https://www.xiaoguantea.com/public/js/lib/easing.Ease"], function(TimelineLite, TweenLite, Ease) {
 ...
 * ----------------------------------------------------------------
 */
	_gsScope._gsDefine("https://www.xiaoguantea.com/public/js/lib/easing.Back", ["https://www.xiaoguantea.com/public/js/lib/easing.Ease"], function(Ease) {
...
(function(window, moduleName) {
		...
		var _namespace = function(ns) {
			 ...
			 * </script>
			 * <script src="TweenMax-1.js"/*tpa=https://www.xiaoguantea.com/public/js/lib/js/greensock/v1.7/TweenMax.js*/></script>
			 * <script>
			 *     window.GreenSockGlobals = window._gsQueue = window._gsDefine = null; //reset it back to null (along with the special _gsQueue variable) so that the next load of TweenMax affects the window and we can reference things directly like TweenLite.to(...)
			 * </script>
			 * <script src="TweenMax-2.js"/*tpa=https://www.xiaoguantea.com/public/js/lib/js/greensock/v1.6/TweenMax.js*/></script>
			 * <script>
			 *     gs.TweenLite.to(...); //would use v1.7
			 *     TweenLite.to(...); //would use v1.6
			 * </script>
			 *
			 * @param {!string} ns The namespace of the class definition, leaving off "com.greensock." as that's assumed. For example, "TweenLite" or "plugins.CSSPlugin" or "https://www.xiaoguantea.com/public/js/lib/easing.Back".
 ...
 */
		var _baseParams = [0, 0, 1, 1],
			_blankArray = [],
			Ease = _class("https://www.xiaoguantea.com/public/js/lib/easing.Ease", function(func, extraParams, type, power) {
				this._func = func;
				this._type = type || 0;
				this._power = power || 0;
